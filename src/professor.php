...
<div class="container">
    ...
    <a href="add_professor.php">Novo Professor</a>
        ...
        while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
            ...
            <tr>
                ...
                <td><?php
                    ...
                    ?></td>
                <td>
                    <a href="edit_professor.php?id=<?= $linha['id'] ?>">Alterar</a>|
                    <a href="delete_professor.php?id=<?= $linha['id'] ?>">Excluir</a>|
                    <a href="view_professor.php?id=<?= $linha['id'] ?>">Visualizar</a>
                </td>
            </tr>
            <?php
        }
