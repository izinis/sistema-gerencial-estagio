...
<div class="container">
    ...
    if (isset($_GET['id'])){
        ...
        <form method="POST" action="../classes/controller/CursoController.php">
            ...
            <div class="row">
                <div class="col">
                    <label for="nome"> Informe o nome da curso: </label>
                    <input type="text" name="nome" class="form-control" value="<?= $resultado['nome'] ?>"/>
                </div>
                <div class="col">
                    <label for="sigla"> Informe o nome da curso: </label>
                    <input type="text" name="sigla" class="form-control" value="<?= $resultado['sigla'] ?>"/>
                </div>
